 ...
 * [The API Documentation](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/thoughtworks/each/each_2.11/0.2.2-SNAPSHOT/each_2.11-0.2.2-SNAPSHOT-javadoc.jar/!/index.html)
 * Utilities
